...
CAPTURE_USER_FIELDS = Transform /^(?:(?:authToken|firstName|lastName|role|href|email|title|institution|phone|role|deactivatedAt|createdAt|updatedAt|userHref)(?:,\s|\sand\s)?(?:no\s)?)+$/ do |fields|
